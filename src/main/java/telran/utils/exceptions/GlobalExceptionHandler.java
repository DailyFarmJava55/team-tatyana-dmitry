...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserAlreadyExists(UserAlreadyExistsException ex) {
	 ...
	 @ExceptionHandler(FarmerNotFoundException.class)
	    public ResponseEntity<Map<String, Object>> handleFarmerNotFound(FarmerNotFoundException e) {
	 ...
	 @ExceptionHandler(SurpriseBoxNotFoundException.class)
	    public ResponseEntity<Map<String, Object>> handleSurpriseBoxNotFound(SurpriseBoxNotFoundException e) {
	        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of(
	            "timestamp", LocalDateTime.now(),
	            "error", "Surprise Box Not Found",
	            "message", e.getMessage()
	        ));
	    }
